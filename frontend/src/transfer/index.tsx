...
const Admin = () => {
  ...
  const handleSubmit = () => {
    transactionStore.doTransfer(currencySource, currencyDestination, amount, account)
  }
      ...
      >
        ...
        <Row>
          <Col>
            ...
            <Input placeholder="Transfer to" type="number" style={{width: '200px'}} value={account} onChange={(e) => setAccount(Number.parseFloat(e.target.value))}></Input>
          </Col>
        </Row>
        <Row>
          <Col>
            <Button type="primary" onClick={() => handleSubmit()}>Transfer</Button>
          </Col>
        </Row>
      </MenuBar>
    </Fragment>
